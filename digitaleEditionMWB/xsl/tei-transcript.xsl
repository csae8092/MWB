    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <!--  Dokumentkopf -->
                <div id="doc_header">
                <div style="margin-bottom:0.2em;padding:0;letter-spacing:0.3em;">Die Transkription</div>
                            ...
                            <xsl:for-each select="tei:TEI/tei:text/tei:body//tei:note[@type='crit_app']">
                                <div class="footnotes">
                                    <xsl:element name="a">
                                        ...
                                        <a>
                                            <xsl:attribute name="href">
                                                <xsl:text>#fna_</xsl:text><xsl:number level="any" format="i" count="tei:note[@type='crit_app']"/>
                                            </xsl:attribute>
                            ...
                            <xsl:for-each select="tei:TEI/tei:text/tei:body//tei:note[@type='source']">
                                <div class="footnotes">
                                    <xsl:element name="a">
                                        ...
                                        <a>
                                            <xsl:attribute name="href">
                                                <xsl:text>#fna_</xsl:text><xsl:number level="any" count="tei:note[@type ='source']"/>
                                            </xsl:attribute>
                                            <span style="font-size:9pt;vertical-align:super;color:blue;"><xsl:number level="any" count="tei:note[@type ='source']"/></span>
                                        </a>
                                        <xsl:apply-templates/>
                                      </xsl:element>
                                </div>
                            ...
                            <xsl:for-each select="tei:TEI/tei:text/tei:body//tei:note[@type='annotation']">
                                <div class="footnotes">
                                    <xsl:element name="a">
                                        ...
                                        <a>
                                            <xsl:attribute name="href">
                                                <xsl:text>#fna_</xsl:text><xsl:number level="any" format="a" count="tei:note[@type ='annotation']"/>
                                            </xsl:attribute>
                                            <span style="font-size:9pt;vertical-align:super;color:red;"><xsl:number level="any" format="a" count="tei:note[@type ='annotation']"/></span>
                                        </a>
                                        <xsl:apply-templates/>
                                    </xsl:element>
                                </div>
...
<!--    Ueberschriften-->
    <xsl:template match="tei:head">
        ...
        <h2 style="background-color:#EEE;padding:0.3em;margin-top:1em;position:relative;width:100%;">
            <div style="position:relative;width:90%;"><xsl:apply-templates select="tei:choice/tei:orig"/></div>
    ...
    <xsl:template match="tei:pb">
        ...
        <div style="margin-top:2em;">
            ...
            <xsl:element name="a">
             ...
             <!--   <xsl:if test="$pvID = 'pv_transcript-facs'"> auskommentiert PA, 5.10.2013 -->
        ...
        <xsl:choose>
            <xsl:when test="parent::tei:div[@type='footnotes' ]">
                ...
                <xsl:element name="a">
                    ...
                    <a>
                        <xsl:attribute name="href">
                            <xsl:text>#fna_</xsl:text><xsl:value-of select="@n"/>
                        </xsl:attribute>
            ...
            <xsl:when test="@type='source'">
                ...
                <xsl:element name="a"> 
                    ...
                    <a>
                        ...
                        <span style="font-size:9pt;vertical-align:super;color:blue;"><xsl:value-of select="$caption"/><xsl:number level="any" count="tei:note[@type ='source']"/></span>
                    </a>
                </xsl:element>
              </xsl:when>
            <xsl:when test="@type='annotation'">
                ...
                <xsl:element name="a"> 
                    ...
                    <a>
                        <xsl:attribute name="href">
                            <xsl:text>#fn</xsl:text><xsl:number level="any" format="a" count="tei:note[@type ='annotation']"/>
                        </xsl:attribute>
                        <xsl:attribute name="title">
                            <xsl:value-of select="normalize-space(.)"/>
                        </xsl:attribute>
                        <span style="font-size:9pt;vertical-align:super;color:red;"><xsl:value-of select="$caption"/><xsl:number level="any" format="a" count="tei:note[@type ='annotation']"/></span>
                    </a>
                </xsl:element>
            </xsl:when>
            <xsl:otherwise>
  ...
  <!--      <span style="color:#cd9db5"> <xsl:apply-templates/></span> -->
    ...
    <xsl:template match="tei:q">
        <xsl:choose>
            ...
            <xsl:when test="@who='12'">
                <span style="background-color:#f7e496"><xsl:apply-templates></xsl:apply-templates></span>
            </xsl:when>
            <xsl:when test="@who='15'">
                <span style="font-size:1em; background-color:#7F4861"><xsl:apply-templates></xsl:apply-templates></span>
            </xsl:when>
            <xsl:when test="@who='20'">
                <span style="font-size:1em; background-color:#81ff5c"><xsl:apply-templates></xsl:apply-templates></span>
            </xsl:when>
    ...
    <xsl:template match="tei:table">
        <table>
            ...
            <xsl:attribute name="style">table-layout:fixed; line-height:1.2em; font-size:1em</xsl:attribute>
            <xsl:apply-templates/>   
        </table>
    </xsl:template>
